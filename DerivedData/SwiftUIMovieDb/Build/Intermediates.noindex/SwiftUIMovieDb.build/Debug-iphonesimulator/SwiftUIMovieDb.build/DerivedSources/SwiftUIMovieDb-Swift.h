...
#ifndef SWIFTUIMOVIEDB_SWIFT_H
#define SWIFTUIMOVIEDB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftUIMovieDb",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14SwiftUIMovieDb11AppDelegate")
...
SWIFT_CLASS("_TtC14SwiftUIMovieDb13SceneDelegate")
